package com.zensar.employee.configuration;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth
			...
			.passwordEncoder(getPasswordEncoder()); //this line tells spring security to use Bean BcryptPasswordENcoder
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.csrf().disable()
			.authorizeRequests()
			.antMatchers("/user/authenticate","/token/validate").permitAll()//this url must be public so that any user can login
			...
			//this is must for rest webserivce  
			//rest should be stateless
		
			//anyrequest - should be authenticated and should use httpbasic
	}
	@Bean
	@Override
